...
fn(state => {
  ...
  const sfFieldMapping = {
    ...
    'pre_challenge_skillz_girl_nih200':{
      ...
      Pre_2__c:'form..i_have_talked_about_hiv_with_a_friend_in_the_past_two_months_outside_skillz',
      Pre_3__c:'form..having_sex_with_an_older_partner_increases_my_risk_of_getting_hiv',
      Pre_4__c:'form.i_have_talked_about_hiv_with_an_adult_in_the_past_two_months_outside_skillz.i_know_where_to_get_contraception_to_prevent_unwanted_pregnancy',
      Pre_5__c:'form.i_have_talked_about_hiv_with_a_friend_in_the_past_two_months_outside_skillz.i_know_someone_in_my_community_who_distributes_contraceptives_and_other_sex',
      Pre_6__c:'form.having_sex_with_an_older_partner_increases_my_risk_of_getting_hiv.having_more_than_one_sexual_partner_increases_my_risk_of_getting_hiv',
      Pre_7__c:'form.i_know_where_to_get_contraception_to_prevent_unwanted_pregnancy.i_have_the_right_to_say_no_to_sex_no_matter_who_asks',
      Pre_8__c:'form.i_know_someone_in_my_community_who_distributes_contraceptives_and_other_sex.as_a_girl_i_have_a_greater_risk_of_getting_hiv_than_boys',
      Pre_9__c:'form.having_more_than_one_sexual_partner_increases_my_risk_of_getting_hiv.i_know_where_to_get_support_services_for_rape',
      Pre_10__c:'form.i_have_the_right_to_say_no_to_sex_no_matter_who_asks.if_a_girl_is_sexually_abused_she_can_reduce_her_risk_of_getting_hiv_by_taki',
      Pre_11__c:'form.as_a_girl_i_have_a_greater_risk_of_getting_hiv_than_boys.i_feel_good_about_being_a_girl',
      Pre_12__c:'form.i_know_where_to_get_support_services_for_rape.it_is_the_mans_responsibility_to_make_decisions_in_a_relationship',
      Pre_13__c:'form.if_a_girl_is_sexually_abused_she_can_reduce_her_risk_of_getting_hiv_by_taki.boys_should_share_the_work_around_the_home_such_as_household_chores',
      Pre_14__c:'form.i_feel_good_about_being_a_girl.i_know_what_i_want_to_be_after_finishing_secondary_school',
      Pre_15__c:'form.it_is_the_mans_responsibility_to_make_decisions_in_a_relationship.if_i_have_a_problem_i_have_someone_in_my_life_i_can_talk_to_for_advise',
      Pre_16__c:'form.boys_should_share_the_work_around_the_home_such_as_household_chores.a_boyfriend_may_have_good_reason_to_hit_his_girlfriend',
      Pre_17__c:'form.i_know_what_i_want_to_be_after_finishing_secondary_school.i_would_tell_someone_if_i_were_touched_in_a_manner_that_made_me_uncomfortab',
      Pre_18__c:'form.if_i_have_a_problem_i_have_someone_in_my_life_i_can_talk_to_for_advise.i_can_reach_my_goals_in_life',
      Pre_19__c:'form.a_boyfriend_may_have_good_reason_to_hit_his_girlfriend.a_girl_should_wait_to_get_married_until_after_college',
      Pre_20__c:'form.i_would_tell_someone_if_i_were_touched_in_a_manner_that_made_me_uncomfortab.biological_and_social_factors_contribute_to_females_and_males_experiencing_',
      Pre_21__c:'form.i_can_reach_my_goals_in_life.the_most_common_illness_of_mental_health_are_depression_and_anxiety',
      Pre_22__c:'form.a_girl_should_wait_to_get_married_until_after_college.mental_health_problems_have_nothing_to_do_with_being_lazy_or_weak_and_many_',
      Pre_23__c:'form.biological_and_social_factors_contribute_to_females_and_males_experiencing_.i_am_ready_to_take_an_hiv_test',
      Pre_24__c:'form.the_most_common_illness_of_mental_health_are_depression_and_anxiety.are_you_or_your_boyfriendgirlfriend_currently_using_any_contraceptive_or_pr',
    }
