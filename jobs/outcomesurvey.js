...
fn((state) => {
  ...
  state.surveyMappings = {
    ...
    Where_to_get_support_services_for_GBV__c: state.capitalizeFirstLetter(state.HIVtestMap[form["i_know_where_to_get_support_services_for_me_or_someone_else_for_gender-base"]]),
